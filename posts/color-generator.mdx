...
---
[This](https://react-projects-9-color-generator.netlify.app/) is what I am trying to replicate. 

[This](/colorgenerator) is what I created. The source code can be found [here](https://github.com/pramam/nextjs-reactprojects/tree/main/components/12-ColorGenerator).
...
_Time to complete: 6 checkins, 2 days_