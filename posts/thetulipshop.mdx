...
description: A four page website with a Cart
---
...
- This is a 4 page app and I needed to preserve cart state as you navigate across these pages
...
- [Path based routing with Next.js](https://spin.atomicobject.com/2019/12/11/role-based-routing-with-next-js/)

- [Sharing data across pages of an app in next.js](https://reacttricks.com/sharing-global-data-in-next-with-custom-app-and-usecontext-hook/)

- [Using the Context API provider in /pages/_app.js to preserve state across pages](https://github.com/vercel/next.js/tree/master/examples/with-context-api)
