    ...
    return (
        <div className="max-w-2xl lg:max-w-5xl">
            <div className="flex flex-col lg:pl-10">
                <h1 className="md:text-3xl mb-2 tracking-wide">{job.title}</h1>
                <h1><span className="inline-flex items-center mb-3 mt-3 px-3 py-0.5 rounded text-sm font-medium bg-gray-400 text-gray-900">{job.company}</span></h1>
