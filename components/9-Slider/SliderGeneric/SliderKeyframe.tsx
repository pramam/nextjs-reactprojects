...
export default function SliderG2({ slides }: IProps) {
                ...
                <div className="relative lg:w-5/1 lg:m-0 lg:p-0 text-left animate-slidy">
                    <div className="flex flex-row justify-center">
                        {slides.map((obj, index) => {
                            ...
                            // const right_props = "transform  translate-x-full";//lg:-translate-y-full
                            // const left_props = "transform -translate-x-full"
                            const right_props = ""
                            const left_props = ""
    ...
    //     // removed lg:h-152 overflow-hidden
    //     <div className="relative bg-red-900 h-156 md:h-168 lg:h-auto">
    //         <div className="">
    //         <div className="flex justify-center">
    ...
    //                                 {/* lg:h-140 lg:top-0 lg:w-224 removed */}
    //                                 <div className="bg-green-900 h-156 md:h-168 w-80 sm:w-128 md:w-128 lg:w-auto">
    //                                 {slides.map((obj, index) => {
    //                                     // All the height and width props are outside of the map
    //                                     // Removed absolute opacity-1
    //                                     const current_props = "transition ease-in-out duration-700";
