        ...
        <div className="min-h-screen bg-gradient-to-tr from-yellow-500 via-red-600 to-yellow-500">
            ...
            <div className="flex justify-center">
                <div className="w-4/5 sm:w-3/5 lg:w-1/2 2xl:w-2/5 mt-20 shadow-lg bg-gray-50 rounded-md">
                    <h1 className="text-2xl sm:text-4xl text-red-600 text-center mt-10">
                        <span className="bg-clip-text text-transparent bg-gradient-to-tr from-red-500 via-red-600 to-red-500">Pallavi Ramam</span></h1>
